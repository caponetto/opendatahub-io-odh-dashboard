...
import { updateConnectionTypeEnabled } from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/connectionTypesService';
...
import CategoryLabel from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/CategoryLabel';
import { getModelServingCompatibility } from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/utils';
import CompatibilityLabel from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/CompatibilityLabel';
import { connectionTypeColumns } from '@odh-dashboard/connection-types/pages/connectionTypes/columns';
import ConnectionTypePreviewModal from '@odh-dashboard/connection-types/concepts/ConnectionTypePreviewModal';
