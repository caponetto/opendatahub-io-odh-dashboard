...
import type { RowProps } from '@odh-dashboard/dashboard-foundation-frontend/utilities/useDraggableTableControlled';
...
import { ValidationErrorCodes } from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/validationUtils';
import { columns } from '@odh-dashboard/connection-types/pages/connectionTypes/manage/fieldTableColumns';
import ConnectionTypeDataFieldRemoveModal from '@odh-dashboard/connection-types/pages/connectionTypes/manage/ConnectionTypeDataFieldRemoveModal';
import ConnectionTypeSectionRemoveModal from '@odh-dashboard/connection-types/pages/connectionTypes/manage/ConnectionTypeSectionRemoveModal';
