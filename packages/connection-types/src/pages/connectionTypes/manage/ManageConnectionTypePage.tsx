...
import { joinWithCommaAnd } from '@odh-dashboard/dashboard-foundation-frontend/utilities/string';
import {
...
} from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/validationUtils';
import {
  ConnectionTypeConfigMapObj,
  ConnectionTypeFormData,
} from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/types';
import { categoryOptions } from '@odh-dashboard/connection-types/pages/connectionTypes/const';
import {
  createConnectionTypeObj,
  extractConnectionTypeFromMap,
} from '@odh-dashboard/connection-types/concepts/createConnectionTypeUtils';
import ConnectionTypePreviewDrawer from '@odh-dashboard/connection-types/concepts/ConnectionTypePreviewDrawer';
