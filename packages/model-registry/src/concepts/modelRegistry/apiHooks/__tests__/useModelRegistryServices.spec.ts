...
import { useRulesReview } from '@odh-dashboard/dashboard-foundation-frontend/api/useRulesReview';
...
} from '@odh-dashboard/model-registry/concepts/modelRegistry/apiHooks/useModelRegistryServices';
import { listServices } from '../../../../api/k8s';
...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/api/useRulesReview');

jest.mock('../../../../api/k8s', () => ({
  ...jest.requireActual<typeof import('../../../../api/k8s')>('../../../../api/k8s'),
