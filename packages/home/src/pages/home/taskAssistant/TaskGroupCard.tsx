...
import SectionIcon from '@odh-dashboard/dashboard-foundation-frontend/concepts/design/SectionIcon';
import { SectionType } from '@odh-dashboard/dashboard-foundation-frontend/concepts/design/utils';
