...
import EvenlySpacedGallery from '@odh-dashboard/dashboard-foundation-frontend/components/EvenlySpacedGallery';
import { isAiProject } from '@odh-dashboard/dashboard-foundation-frontend/concepts/projects/utils';
