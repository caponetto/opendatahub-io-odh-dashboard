...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/utilities/quickStartUtils', () => ({
  ...jest.requireActual('@odh-dashboard/dashboard-foundation-frontend/utilities/quickStartUtils'),
  getQuickStartCompletionStatus: jest.fn(),
}));

const mockGetQuickStartCompletionStatus = jest.mocked(
  jest.requireMock<
    typeof import('@odh-dashboard/dashboard-foundation-frontend/utilities/quickStartUtils')
  >('@odh-dashboard/dashboard-foundation-frontend/utilities/quickStartUtils')
