...
import * as BrowserUnloadBlocker from '@odh-dashboard/dashboard-foundation-frontend/utilities/useBrowserUnloadBlocker';
import DashboardDescriptionListGroup from '@odh-dashboard/dashboard-foundation-frontend/components/DashboardDescriptionListGroup';
import '@testing-library/jest-dom';

jest.mock('@odh-dashboard/dashboard-foundation-frontend/components/NavigationBlockerModal', () => ({
  __esModule: true,
  default: jest
    .fn()
...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/utilities/useBrowserUnloadBlocker', () => ({
