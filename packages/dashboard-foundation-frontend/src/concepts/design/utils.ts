import projectImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Folder-RGB.svg';
import notebookImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Wrench-RGB.svg';
import pipelineImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Branch-RGB.svg';
import pipelineRunImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Double_arrow_right-RGB.svg';
import clusterStorageImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Storage-RGB.svg';
import modelServerImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Server-RGB.svg';
import registeredModelsImg from '@odh-dashboard/dashboard-foundation-frontend/images/Icon-Red_Hat-Layered_A_Black-RGB.svg';
import deployedModelsImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Cubes-RGB.svg';
import deployingModelsImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Server_upload-RGB.svg';
import dataConnectionImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Connected-RGB.svg';
import userImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-User-RGB.svg';
import groupImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Shared_workspace-RGB.svg';
import projectEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-project-overview.svg';
import notebookEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-notebooks.svg';
import pipelineEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-pipelines.svg';
import clusterStorageEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-cluster-storage.svg';
import modelServerEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-model-serving.svg';
import dataConnectionEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-data-connections.svg';
import modelRegistryEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-model-registries.svg';
import storageClassesEmptyStateImg from '@odh-dashboard/dashboard-foundation-frontend/images/empty-state-storage-classes.svg';
import modelRegistryMissingModelImg from '@odh-dashboard/dashboard-foundation-frontend/images/no-models-model-registry.svg';
import modelRegistryMissingVersionImg from '@odh-dashboard/dashboard-foundation-frontend/images/no-versions-model-registry.svg';
import modelRegistrySelectImg from '@odh-dashboard/dashboard-foundation-frontend/images/UI_icon-Red_Hat-Registered.svg';
