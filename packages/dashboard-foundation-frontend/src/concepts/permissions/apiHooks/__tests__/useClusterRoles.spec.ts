...
import { listClusterRoles } from '@odh-dashboard/dashboard-foundation-frontend/api/k8s/clusterRoles';
import useFetch from '@odh-dashboard/dashboard-foundation-frontend/utilities/useFetch';
import { useClusterRoles } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useClusterRoles';

jest.mock('@odh-dashboard/dashboard-foundation-frontend/api/k8s/clusterRoles', () => ({
