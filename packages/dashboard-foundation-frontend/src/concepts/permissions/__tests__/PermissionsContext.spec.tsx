...
jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useRoles',
  () => ({
    useRoles: jest.fn(),
  }),
);
...
jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useRoleBindings',
  () => ({
...
jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useClusterRoles',
  () => ({
    useClusterRoles: jest.fn(),
  }),
);

const mockUseRoles = jest.requireMock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useRoles',
).useRoles as jest.Mock;
const mockUseRoleBindings = jest.requireMock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useRoleBindings',
).useRoleBindings as jest.Mock;
const mockUseClusterRoles = jest.requireMock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/apiHooks/useClusterRoles',
