...
import { fetchSegmentKey } from '@odh-dashboard/dashboard-foundation-frontend/concepts/analyticsTracking/segmentKeyService';
import { useWatchSegmentKey } from '@odh-dashboard/dashboard-foundation-frontend/concepts/analyticsTracking/useWatchSegmentKey';

jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/analyticsTracking/segmentKeyService',
  () => ({
