import { K8sResourceCommon, MatchExpression } from '@odh-dashboard/k8s-browser';
import type { EitherNotBoth } from '#~/typeHelpers';
import { AwsKeys } from '#~/constants/awsKeys';
...
export type { K8sResourceCommon } from '@odh-dashboard/k8s-browser';
