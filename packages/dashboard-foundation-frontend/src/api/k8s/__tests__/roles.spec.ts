import { k8sCreateResource, k8sGetResource } from '@odh-dashboard/k8s-browser';
import { mockRoleK8sResource } from '@odh-dashboard/test-mocks/mockRoleK8sResource';
import { KnownLabels, RoleKind } from '../../../k8sTypes';
import { createRole, generateRoleInferenceService, getRole } from '../roles';
import { RoleModel } from '../../models/k8s';
