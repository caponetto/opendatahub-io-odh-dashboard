...
import { PvcModelAnnotation, StorageData } from '#~/api/k8s/workbenchStorageTypes';
import { translateDisplayNameForK8s } from '#~/concepts/k8s/utils';
import { AccessMode, K8sAPIOptions, KnownLabels, PersistentVolumeClaimKind } from '#~/k8sTypes';
