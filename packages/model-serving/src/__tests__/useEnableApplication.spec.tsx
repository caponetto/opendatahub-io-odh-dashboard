...
} from '@odh-dashboard/dashboard-foundation-frontend/utilities/useEnableApplication';
import { postValidateIsv } from '@odh-dashboard/dashboard-foundation-frontend/services/validateIsvService';
import {
  enableIntegrationApp,
  getIntegrationAppEnablementStatus,
} from '@odh-dashboard/dashboard-foundation-frontend/services/integrationAppService';
import * as reduxHooks from '@odh-dashboard/dashboard-foundation-frontend/redux/hooks';
import { VariablesValidationStatus } from '@odh-dashboard/dashboard-foundation-frontend/types';
import useServingPlatformStatuses from '../pages/useServingPlatformStatuses';

jest.mock('../pages/useServingPlatformStatuses');

jest.mock('@odh-dashboard/dashboard-foundation-frontend/services/validateIsvService', () => ({
