import { K8sStatus, k8sDeleteResource } from '@odh-dashboard/k8s-browser';
...
import { assembleServingRuntimeTemplate, deleteTemplate, useTemplates } from '../templates';
...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/utilities/string', () => ({
...
jest.mock('../../../pages/useModelServingEnabled', () => ({
  __esModule: true,
  default: jest.fn(),
}));

jest.mock('../../../pages/customServingRuntimes/useCustomServingRuntimesEnabled', () => ({
  __esModule: true,
  default: jest.fn(),
}));
