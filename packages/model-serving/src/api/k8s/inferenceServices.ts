...
import { parseCommandLine } from '@odh-dashboard/dashboard-foundation-frontend/api/k8s/utils';
import { getModelServingProjects } from '@odh-dashboard/dashboard-foundation-frontend/api/k8s/projects';
import { CreatingInferenceServiceObject } from '../../pages/screens/types';
import { InferenceServiceModel } from '../models/kserve';
