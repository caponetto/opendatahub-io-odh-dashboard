...
import { defaultResponsePredicate } from '@odh-dashboard/dashboard-foundation-frontend/api/prometheus/usePrometheusQueryRange';
import {
  SupportedArea,
  useIsAreaAvailable,
...
import {
  PendingContextResourceData,
  PrometheusQueryRangeResultValue,
} from '@odh-dashboard/dashboard-foundation-frontend/types';
import { DEFAULT_PENDING_CONTEXT_RESOURCE } from '@odh-dashboard/dashboard-foundation-frontend/api/prometheus/const';
import {
  KserveMetricGraphDefinition,
  NimMetricGraphDefinition,
} from '@odh-dashboard/model-serving/concepts/metrics/kserve/types';
