...
import { getDashboardConfigTemplateOrderBackend } from '@odh-dashboard/model-serving-shared/services/dashboardService';
import useFetch, {
  FetchOptions,
  FetchStateObject,
  NotReadyError,
...
import { getDashboardConfigTemplateOrder } from '../../api/k8s/dashboardConfig';
