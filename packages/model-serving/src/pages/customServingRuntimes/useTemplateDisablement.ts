...
import { getDashboardConfigTemplateDisablementBackend } from '@odh-dashboard/model-serving-shared/services/dashboardService';
import useFetch, {
  FetchOptions,
  FetchStateObject,
  NotReadyError,
...
import { getDashboardConfigTemplateDisablement } from '../../api/k8s/dashboardConfig';
