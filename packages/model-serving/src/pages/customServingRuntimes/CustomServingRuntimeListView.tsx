...
import { patchDashboardConfigTemplateOrderBackend } from '@odh-dashboard/model-serving-shared/services/dashboardService';
...
const CustomServingRuntimeListView: React.FC = () => {
  ...
  const safeTemplates = React.useMemo(() => unsortedTemplates ?? [], [unsortedTemplates]);

  const sortedTemplates = React.useMemo(
    () => getSortedTemplates(safeTemplates, templateOrder),
    [safeTemplates, templateOrder],
  );
