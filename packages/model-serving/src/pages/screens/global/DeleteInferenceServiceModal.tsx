...
import { deleteInferenceService } from '../../../api/k8s/inferenceServices';
import { deleteServingRuntime } from '../../../api/k8s/servingRuntimes';
import { getNIMResourcesToDelete, isProjectNIMSupported } from '../projects/nim/nimUtils';
