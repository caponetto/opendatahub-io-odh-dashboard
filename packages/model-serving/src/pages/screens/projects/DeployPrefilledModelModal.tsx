...
import { isRedHatRegistryUri } from '@odh-dashboard/dashboard-foundation-frontend/concepts/modelRegistry/utils';
import useServingConnections from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/useServingConnections';
import ProjectSelector from './InferenceServiceModal/ProjectSelector';
import ManageKServeModal from './kServeModal/ManageKServeModal';
import { getProjectModelServingPlatform } from './utils';
...
import ModelServingContextProvider, { ModelServingContext } from '../../ModelServingContext';
import { getKServeTemplates } from '../../customServingRuntimes/utils';
import { isOciModelUri } from '../../utils';
