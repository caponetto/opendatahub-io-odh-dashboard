...
} from '@odh-dashboard/dashboard-foundation-frontend/constants/dataConnectionConst';
...
import { PrefilledConnection } from '@odh-dashboard/model-serving-shared/types/types';
