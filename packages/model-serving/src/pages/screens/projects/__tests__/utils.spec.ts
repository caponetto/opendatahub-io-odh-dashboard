...
import { createPvc, createSecret } from '@odh-dashboard/dashboard-foundation-frontend/api';
import {
...
import { getNIMData, getNIMResource, updateServingRuntimeTemplate } from '../nim/nimUtils';
import { ServingPlatformStatuses } from '../../types';
import {
  createNIMPVC,
  createNIMSecret,
  fetchNIMModelNames,
...
jest.mock('../../../../api/k8s/inferenceServices', () => ({
  ...jest.requireActual('../../../../api/k8s/inferenceServices'),
  getInferenceServiceContext: jest.fn(),
}));

jest.mock('../nim/nimUtils', () => ({
  ...jest.requireActual('../nim/nimUtils'),
  getNIMData: jest.fn(),
