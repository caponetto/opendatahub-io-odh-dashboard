...
import { DEPLOY_BUTTON_TOOLTIP } from '@odh-dashboard/model-serving-shared/constants/deployButtonTooltip';
...
jest.mock('../../../useServingPlatformStatuses', () => jest.fn());

const mockUseIsAreaAvailable =
  require('@odh-dashboard/dashboard-foundation-frontend/concepts/areas').useIsAreaAvailable;
const mockUseServingPlatformStatuses = require('../../../useServingPlatformStatuses');
