...
import { mockStorageClasses } from '@odh-dashboard/test-mocks/mockStorageClasses';
...
import * as storageConfigModule from '@odh-dashboard/storage-classes-shared/concepts/storageClasses/useGetStorageClassConfig';
import * as StorageClassSelectModule from '@odh-dashboard/storage-classes-shared/concepts/storageClasses/StorageClassSelect';
import * as useDefaultStorageClassModule from '@odh-dashboard/storage-classes-shared/concepts/storageClasses/useDefaultStorageClass';
import * as useAssignHardwareProfileModule from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/useAssignHardwareProfile';
import * as useNIMPVCModule from '../useNIMPVC';
import * as utils from '../../../utils';
import { ServingRuntimeEditInfo } from '../../../../types';
import ManageNIMServingModal from '../ManageNIMServingModal';
...
jest.mock('../../../../../customServingRuntimes/useCustomServingRuntimesEnabled', () => ({
  __esModule: true,
...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/api', () => ({
  getSecret: jest.fn(),
  updatePvc: jest.fn(),
...
jest.mock('../../../../../customServingRuntimes/utils', () => ({
  getServingRuntimeFromTemplate: jest.fn(),
}));

jest.mock('../../useNIMTemplateName', () => ({
...
jest.mock(
  '@odh-dashboard/storage-classes-shared/concepts/storageClasses/StorageClassSelect',
  () => ({
    __esModule: true,
...
jest.mock(
  '@odh-dashboard/storage-classes-shared/concepts/storageClasses/useDefaultStorageClass',
  () => ({
    __esModule: true,
...
jest.mock('../../../useModelDeploymentNotification', () => ({
...
jest.mock(
  '@odh-dashboard/storage-classes-shared/concepts/storageClasses/useGetStorageClassConfig',
  () => ({
...
jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/dashboard/DashboardModalFooter',
  () => ({
    __esModule: true,
...
describe('ManageNIMServingModal', () => {
  ...
  describe('Authentication', () => {
    it('does not show NoAuthAlert when auth is available', () => {
      const {
        useIsAreaAvailable,
      } = require('@odh-dashboard/dashboard-foundation-frontend/concepts/areas');
