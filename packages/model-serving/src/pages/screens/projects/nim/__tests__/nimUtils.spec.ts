...
import { deletePvc, deleteSecret, getPvc } from '@odh-dashboard/dashboard-foundation-frontend/api';
...
import { fetchInferenceServiceCount } from '../fetchInferenceServiceCount';
import { listNIMAccounts } from '../../../../../api/k8s/nimAccounts';
...
jest.mock('../../../../../api/k8s/nimAccounts', () => ({
  listNIMAccounts: jest.fn(),
}));

jest.mock('../../../../../api/k8s/servingRuntimes', () => ({
  listServingRuntimes: jest.fn(),
}));

jest.mock('../fetchInferenceServiceCount', () => ({
