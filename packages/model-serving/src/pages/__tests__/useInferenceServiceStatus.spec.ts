...
import { useInferenceServiceStatus } from '../useInferenceServiceStatus';
import { getInferenceServiceStoppedStatus } from '../utils';

// Mock dependencies
jest.mock('../useModelPodStatus');
jest.mock('../../concepts/kserve/kserveStatusUtils');
jest.mock('../utils');
...
jest.mocked(require('../useModelPodStatus').default).mockImplementation(mockUseModelPodStatus);
