...
import { ModelServingPodSpecOptionsState } from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/deprecated/useModelServingAcceleratorDeprecatedPodSpecOptionsState';
import {
  getInferenceServiceSizeOrReturnEmpty,
  getServingRuntimeOrReturnEmpty,
} from '@odh-dashboard/dashboard-foundation-frontend/utilities/modelServingResourceUtils';
import { ServingRuntimeVersionStatusLabel } from '../screens/const';
import { CreatingServingRuntimeObject, ServingRuntimeEditInfo } from '../screens/types';
import {
  getKServeContainer,
...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/api', () => ({
  ...jest.requireActual('@odh-dashboard/dashboard-foundation-frontend/api'),
