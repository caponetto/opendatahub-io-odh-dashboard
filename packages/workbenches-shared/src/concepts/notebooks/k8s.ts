...
import {
  getshmVolume,
  getshmVolumeMount,
} from '@odh-dashboard/dashboard-foundation-frontend/api/k8s/utils';
import { k8sMergePatchResource } from '@odh-dashboard/dashboard-foundation-frontend/api/k8sUtils';
import { NotebookModel } from '@odh-dashboard/dashboard-foundation-frontend/api/models';
import { ROOT_MOUNT_PATH } from '@odh-dashboard/dashboard-foundation-frontend/concepts/k8s/const';
import { EnvironmentFromVariable } from '@odh-dashboard/dashboard-foundation-frontend/concepts/projects/types';
import { getImageStreamDisplayName } from '@odh-dashboard/dashboard-foundation-frontend/utilities/imageStreamUtils';
import {
  ImageStreamKind,
