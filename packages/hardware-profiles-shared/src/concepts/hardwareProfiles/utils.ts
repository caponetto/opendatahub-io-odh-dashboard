...
import { K8sResourceCommon, Patch } from '@odh-dashboard/k8s-browser';
...
import { REMOVE_HARDWARE_PROFILE_ANNOTATIONS_PATCH } from '#~/concepts/hardwareProfiles/const';
import {
...
export { formatResourceValue } from '#~/concepts/hardwareProfiles/resourceFormatting';
