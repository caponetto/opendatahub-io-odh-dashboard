...
import { ContainerResources, Identifier } from '@odh-dashboard/dashboard-foundation-frontend/types';
import CPUField from '@odh-dashboard/dashboard-foundation-frontend/components/CPUField';
import MemoryField from '@odh-dashboard/dashboard-foundation-frontend/components/MemoryField';
...
import { formatResourceValue } from '#~/concepts/hardwareProfiles/resourceFormatting';
