...
import ProjectScopedIcon from '@odh-dashboard/dashboard-foundation-frontend/components/searchSelector/ProjectScopedIcon';
import {
...
import type { HardwareProfileConfig } from '#~/concepts/hardwareProfiles/useHardwareProfileConfig';
import HardwareProfileDetailsPopover from '#~/concepts/hardwareProfiles/HardwareProfileDetailsPopover';
import { useWatchHardwareProfileOrder } from '#~/concepts/hardwareProfiles/useWatchHardwareProfileOrder';
...
const HardwareProfileSelect: React.FC<HardwareProfileSelectProps> = ({
  ...
  const hardwareProfileOrder = useWatchHardwareProfileOrder();
