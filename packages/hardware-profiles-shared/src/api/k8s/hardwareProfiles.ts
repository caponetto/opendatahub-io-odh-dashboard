...
import { HardwareProfileModel } from '@odh-dashboard/dashboard-foundation-frontend/api/models';
import { applyK8sAPIOptions } from '@odh-dashboard/dashboard-foundation-frontend/api/apiMergeUtils';
import { DisplayNameAnnotation } from '@odh-dashboard/dashboard-foundation-frontend/types';
