...
import { useMLflowStatus } from '@odh-dashboard/mlflow-embedded/concepts/hooks/useMLflowStatus';
import useIsMlflowCRAvailable from '@odh-dashboard/mlflow-embedded/concepts/hooks/useIsMlflowCRAvailable';
...
jest.mock('@odh-dashboard/mlflow-embedded/concepts/hooks/useMLflowStatus', () => ({
