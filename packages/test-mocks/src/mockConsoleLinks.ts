import { ConsoleLinkKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import { MOCK_MLFLOW_ICON, MOCK_ODH_ICON } from '@odh-dashboard/test-mocks/mockIcon';
