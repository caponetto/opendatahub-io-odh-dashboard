import { KnownLabels, ServingRuntimeKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import { ServingRuntimeAPIProtocol, ContainerResources, NodeSelector, Toleration } from '@odh-dashboard/dashboard-foundation-frontend/types';
