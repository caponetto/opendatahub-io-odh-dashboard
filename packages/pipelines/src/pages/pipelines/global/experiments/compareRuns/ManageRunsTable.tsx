...
import { compareRunsRoute } from '@odh-dashboard/pipelines/routes/runs';
import { pipelineRunColumns } from '@odh-dashboard/pipelines/concepts/content/tables/columns';
import PipelineRunTable from '@odh-dashboard/pipelines/concepts/content/tables/pipelineRun/PipelineRunTable';
...
import { ExperimentKF, PipelineRunKF } from '@odh-dashboard/pipelines/concepts/kfTypes';
