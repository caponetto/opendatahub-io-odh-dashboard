...
import { useGetArtifactTypes } from '@odh-dashboard/pipelines/concepts/apiHooks/mlmd/useGetArtifactTypes';
import { useGetEventsByExecutionId } from '@odh-dashboard/pipelines/concepts/apiHooks/mlmd/useGetEventsByExecutionId';
import { useGetExecutionById } from '@odh-dashboard/pipelines/concepts/apiHooks/mlmd/useGetExecutionById';
import { PipelineCoreDetailsPageComponent } from '@odh-dashboard/pipelines/concepts/content/types';
import { inputOutputSectionTitle } from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/const';
import ExecutionDetailsCustomPropertiesSection from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/details/ExecutionDetailsCustomPropertiesSection';
import ExecutionDetailsIDSection from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/details/ExecutionDetailsIDSection';
import ExecutionDetailsInputOutputSection from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/details/ExecutionDetailsInputOutputSection';
import ExecutionDetailsPropertiesSection from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/details/ExecutionDetailsPropertiesSection';
import ExecutionDetailsReferenceSection from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/details/ExecutionDetailsReferenceSection';
...
import {
  ...
  parseEventsByType,
} from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/executions/utils';
