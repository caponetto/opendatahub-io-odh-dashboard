...
import { ArtifactDetails } from '@odh-dashboard/pipelines/pages/pipelines/global/experiments/artifacts/ArtifactDetails/ArtifactDetails';
import GlobalPipelineCoreDetails from '@odh-dashboard/pipelines/pages/pipelines/global/GlobalPipelineCoreDetails';
import * as useGetArtifactById from '@odh-dashboard/pipelines/concepts/apiHooks/mlmd/useGetArtifactById';
import * as useArtifactStorage from '@odh-dashboard/pipelines/concepts/apiHooks/useArtifactStorage';
...
jest.mock('@odh-dashboard/pipelines/concepts/apiHooks/useArtifactStorage');
