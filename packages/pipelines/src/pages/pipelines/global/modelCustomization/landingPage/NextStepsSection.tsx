...
import { modelCatalogRoute } from '@odh-dashboard/model-serving-shared/routes/modelRegistry';
import { pipelineRunsRootPath } from '@odh-dashboard/pipelines/routes/runs';
import { ModelCustomizationAccordionItem } from '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/landingPage/ModelCustomizationAccordionItem';
import { BaseSection } from '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/landingPage/BaseSection';
import { useToggleAccordion } from '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/landingPage/useToggleAccordion';
    ...
    <BaseSection title={<Title headingLevel="h3">Now that you&#39;re all set up:</Title>}>
      <Accordion togglePosition="start" data-testid="accordion-next-steps">
        ...
        >
          ...
          <Link data-testid="go-to-model-registry" to="/ai-hub/models/registry">
            Model registry page
          </Link>
          .
        </ModelCustomizationAccordionItem>
