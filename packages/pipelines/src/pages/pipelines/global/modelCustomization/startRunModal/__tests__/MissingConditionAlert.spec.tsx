...
import {
  ContinueCondition,
  useContinueState,
} from '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/startRunModal/useContinueState';
import MissingConditionAlert from '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/startRunModal/MissingConditionAlert';
import '@testing-library/jest-dom';

jest.mock(
  '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/startRunModal/useContinueState',
  () => ({
