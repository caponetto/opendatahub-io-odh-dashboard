...
import { useContinueState } from '@odh-dashboard/pipelines/pages/pipelines/global/modelCustomization/startRunModal/useContinueState';

jest.mock('@odh-dashboard/pipelines/concepts/context');
jest.mock('@odh-dashboard/pipelines/concepts/content/modelCustomizationForm/useIlabPipeline');
