...
import ScheduledRuns from '@odh-dashboard/pipelines/pages/pipelines/global/runs/ScheduledRuns';
import { ActiveRuns } from '@odh-dashboard/pipelines/pages/pipelines/global/runs/ActiveRuns';
import { ArchivedRuns } from '@odh-dashboard/pipelines/pages/pipelines/global/runs/ArchivedRuns';
import {
  PipelineRunType,
  PipelineRunTabTitle,
} from '@odh-dashboard/pipelines/pages/pipelines/global/runs/types';
