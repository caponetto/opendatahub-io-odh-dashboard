...
import { DataSciencePipelineApplicationModel } from '@odh-dashboard/dashboard-foundation-frontend/api/models/odh';
import { RouteModel } from '@odh-dashboard/dashboard-foundation-frontend/api/models/openShift';
...
describe('createPipelinesCR', () => {
  ...
  const expectedResource: DSPipelineKind = {
