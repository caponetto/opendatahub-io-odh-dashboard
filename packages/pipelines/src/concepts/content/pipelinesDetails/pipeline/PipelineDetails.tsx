...
import PipelineDetailsYAML from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/PipelineDetailsYAML';
...
import PipelineTopologyEmpty from '../../../topology/PipelineTopologyEmpty';
