...
import TaskDetailsPrintKeyValues from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/taskDetails/TaskDetailsPrintKeyValues';
import { PipelineTaskArtifact } from '@odh-dashboard/pipelines/concepts/topology';
