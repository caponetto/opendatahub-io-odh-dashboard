...
import { ArtifactType } from '@odh-dashboard/pipelines/concepts/kfTypes';
import {
  buildRocCurveConfig,
  isConfidenceMetric,
} from '@odh-dashboard/pipelines/concepts/content/compareRuns/metricsSection/roc/utils';
import ROCCurve from '@odh-dashboard/pipelines/concepts/content/artifacts/charts/ROCCurve';
...
import { isConfusionMatrix } from '@odh-dashboard/pipelines/concepts/content/compareRuns/metricsSection/confusionMatrix/utils';
