...
import { ArtifactNodeDrawerContent } from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/pipelineRun/artifacts/ArtifactNodeDrawerContent';
...
jest.mock(
  '@odh-dashboard/pipelines/concepts/content/compareRuns/metricsSection/confusionMatrix/utils',
  () => ({
    isConfusionMatrix: jest.fn(() => true),
  }),
);

jest.mock('@odh-dashboard/pipelines/concepts/content/compareRuns/metricsSection/roc/utils', () => ({
...
jest.mock(
  '@odh-dashboard/pipelines/concepts/content/artifacts/charts/confusionMatrix/utils',
  () => ({
...
jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/areas/useIsAreaAvailable',
  () => () => ({
    status: true,
    featureFlags: {},
    reliantAreas: {},
...
jest.mock('@odh-dashboard/pipelines/concepts/context/PipelinesContext', () => ({
