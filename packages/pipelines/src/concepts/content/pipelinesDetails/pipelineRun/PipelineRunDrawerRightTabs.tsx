...
import SelectedNodeDetailsTab from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/pipelineRun/SelectedNodeDetailsTab';
import SelectedNodeInputOutputTab from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/pipelineRun/SelectedNodeInputOutputTab';
import LogsTab from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/pipelineRun/runLogs/LogsTab';
