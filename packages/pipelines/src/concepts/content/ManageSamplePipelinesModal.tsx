...
import { DSPipelineManagedPipelinesKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import useNotification from '@odh-dashboard/dashboard-foundation-frontend/utilities/useNotification';
import { getPipelinesCR, toggleInstructLabState } from '@odh-dashboard/pipelines/api/k8s';
