...
import useNamespaceSecret from '@odh-dashboard/connection-types-shared/concepts/projects/apiHooks/useNamespaceSecret';
...
import ManagePipelineServerModal from '@odh-dashboard/pipelines/concepts/content/ManagePipelineServerModal';
import { updatePipelineCaching } from '../../../api/k8s';
...
jest.mock(
  '@odh-dashboard/connection-types-shared/concepts/projects/apiHooks/useNamespaceSecret',
  () => ({
    __esModule: true,
    default: jest.fn(),
  }),
