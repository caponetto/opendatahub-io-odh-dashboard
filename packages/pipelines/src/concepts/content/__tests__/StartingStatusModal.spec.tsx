...
import StartingStatusModal from '@odh-dashboard/pipelines/concepts/content/StartingStatusModal';
...
jest.mock('@odh-dashboard/pipelines/concepts/context/usePipelineEvents', () => ({
