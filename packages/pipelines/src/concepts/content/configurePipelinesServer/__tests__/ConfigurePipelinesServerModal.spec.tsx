...
import { NotificationWatcherContext } from '@odh-dashboard/dashboard-foundation-frontend/concepts/notificationWatcher/NotificationWatcherContext';
...
import { createPipelinesCR } from '@odh-dashboard/pipelines/api/k8s';
import { usePipelinesAPI } from '@odh-dashboard/pipelines/concepts/context';
import { ConfigurePipelinesServerModal } from '@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/ConfigurePipelinesServerModal';
import { configureDSPipelineResourceSpec } from '@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/utils';
...
jest.mock(
  '@odh-dashboard/connection-types-shared/concepts/connectionTypes/usePipelinesConnections',
  () => ({
    __esModule: true,
    default: jest.fn(),
  }),
...
jest.mock('@odh-dashboard/pipelines/api/k8s', () => ({
...
jest.mock('@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/utils', () => ({
...
jest.mock(
  '@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/ObjectStorageSection',
  () => ({
...
jest.mock(
  '@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/PipelinesDatabaseSection',
  () => ({
...
jest.mock(
  '@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/SamplePipelineSettingsSection',
  () => ({
    __esModule: true,
...
describe('ConfigurePipelinesServerModal', () => {
  ...
  it('should enable submit button when form is valid', () => {
    ...
    } = require('@odh-dashboard/pipelines/concepts/content/configurePipelinesServer/utils');
