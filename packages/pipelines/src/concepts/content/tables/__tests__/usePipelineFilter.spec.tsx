...
import { buildMockExperimentKF, buildMockPipelineVersion } from '@odh-dashboard/test-mocks';
...
import { PipelinesFilterOp } from '@odh-dashboard/pipelines/concepts/kfTypes';
...
jest.mock('@odh-dashboard/pipelines/concepts/mlflow/useIsMlflowPipelinesAvailable', () => ({
  __esModule: true,
  default: jest.fn(() => ({ available: false, loaded: true })),
}));
