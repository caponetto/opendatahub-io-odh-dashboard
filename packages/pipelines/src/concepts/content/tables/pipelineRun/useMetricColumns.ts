...
import { useGetArtifactsByRuns } from '@odh-dashboard/pipelines/concepts/apiHooks/mlmd/useGetArtifactsByRuns';
import { ArtifactType, PipelineRunKF } from '@odh-dashboard/pipelines/concepts/kfTypes';
import { getArtifactProperties } from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/pipelineRun/artifacts/utils';
import { ArtifactProperty } from '@odh-dashboard/pipelines/concepts/content/pipelinesDetails/pipelineRun/artifacts/types';
import { RunWithMetrics } from '@odh-dashboard/pipelines/concepts/content/tables/pipelineRun/types';
