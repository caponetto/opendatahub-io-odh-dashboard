...
import PipelineVersionTable from '@odh-dashboard/pipelines/concepts/content/tables/pipelineVersion/PipelineVersionTable';
...
import { getTableSortProps } from '@odh-dashboard/pipelines/concepts/content/tables/usePipelineTable';
