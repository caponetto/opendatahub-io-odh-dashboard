import { buildMockPipelineVersion } from '@odh-dashboard/test-mocks';

import { mockIlabPipelineVersionParameters } from '@odh-dashboard/test-mocks/mockIlabPipelineVersionParameters';
