...
import MlflowIntegrationSection from '@odh-dashboard/pipelines/concepts/content/createRun/contentSections/MlflowIntegrationSection';
import { getDefaultMlflowFormData } from '@odh-dashboard/pipelines/concepts/content/createRun/utils';
import { MlflowExperimentMode } from '@odh-dashboard/pipelines/concepts/content/createRun/types';
...
jest.mock('@odh-dashboard/pipelines/concepts/mlflow/useMlflowIntegration', () => {
  ...
  return {
    __esModule: true,
    MlflowExperimentSelector: MockMlflowExperimentSelector,
  };
});

jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/dashboard/DashboardHelpTooltip',
  () => {
    ...
    return {
      __esModule: true,
      default: MockDashboardHelpTooltip,
    };
  },
);
