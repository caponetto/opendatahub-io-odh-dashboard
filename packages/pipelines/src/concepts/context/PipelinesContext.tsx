...
import ManagePipelineServerModal from '@odh-dashboard/pipelines/concepts/content/ManagePipelineServerModal.tsx';
...
import DeletePipelineServerModal from '@odh-dashboard/pipelines/concepts/content/DeletePipelineServerModal';
