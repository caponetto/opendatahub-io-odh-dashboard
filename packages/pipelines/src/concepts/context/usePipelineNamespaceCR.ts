...
import { DSPipelineKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
...
import { getPipelinesCR, listPipelinesCR } from '@odh-dashboard/pipelines/api/k8s';
