...
export const secureRoute =
  ...
  async (request: FastifyRequest, reply: FastifyReply): Promise<T> => {
    // eslint-disable-next-line @typescript-eslint/consistent-type-assertions -- narrowed at runtime by handleSecurityOnRouteData
    await handleSecurityOnRouteData(fastify, request as OauthFastifyRequest, needsAdmin);
