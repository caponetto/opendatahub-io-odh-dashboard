...
import { DataScienceClusterComponentStatus } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import {
  useUser,
  useClusterInfo,
...
import ExternalLink from '@odh-dashboard/dashboard-foundation-frontend/components/ExternalLink';
