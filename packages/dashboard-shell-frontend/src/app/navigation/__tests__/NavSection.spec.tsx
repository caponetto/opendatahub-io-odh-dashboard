...
import type { CodeRef, LoadedExtension } from '@odh-dashboard/plugin-core';
import type {
  NavSectionExtension,
...
import { useAccessReviewExtensions } from '@odh-dashboard/dashboard-foundation-frontend/utilities/useAccessReviewExtensions';
...
jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/utilities/useAccessReviewExtensions',
  () => ({
...
jest.mock('@odh-dashboard/dashboard-shell-frontend/app/navigation/NavIcon', () => ({
  __esModule: true,
...
jest.mock('@odh-dashboard/dashboard-shell-frontend/app/status-provider/StatusReportIcon', () => ({
...
jest.mock('@odh-dashboard/dashboard-shell-frontend/app/status-provider/utils', () => ({
...
describe('NavSection', () => {
    ...
    it('should render section with icon when iconRef is provided', () => {
      const sectionWithIcon: LoadedExtension<NavSectionExtension> = {
        ...
        properties: {
          ...
          iconRef: (() =>
            import(
              '@odh-dashboard/dashboard-foundation-frontend/images/icons/SettingsNavIcon'
            )) as CodeRef<{
  ...
  describe('Status reporting', () => {
    it('should pass onNotifyStatus callback to NavItem children', () => {
      ...
      jest
        .spyOn(require('@odh-dashboard/dashboard-shell-frontend/app/navigation/NavItem'), 'NavItem')
        .mockImplementation(NavItemMock);
