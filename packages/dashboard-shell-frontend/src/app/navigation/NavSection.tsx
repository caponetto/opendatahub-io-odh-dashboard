...
import type { Extension, LoadedExtension } from '@odh-dashboard/plugin-core';
import {
  StatusReport,
  NavSectionExtension,
  NavExtension,
...
import { getStatusReportSummary } from '../status-provider/utils';
import { StatusReportIcon } from '../status-provider/StatusReportIcon';
