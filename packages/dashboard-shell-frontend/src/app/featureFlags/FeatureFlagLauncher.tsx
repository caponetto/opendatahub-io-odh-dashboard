...
import type { FeatureFlagProps } from '@odh-dashboard/dashboard-foundation-frontend/types';
import { DashboardCommonConfig } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
