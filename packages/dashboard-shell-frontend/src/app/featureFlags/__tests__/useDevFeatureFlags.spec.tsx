...
import { definedFeatureFlags } from '@odh-dashboard/dashboard-foundation-frontend/concepts/areas';
import { DashboardConfigKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import axios from '@odh-dashboard/dashboard-foundation-frontend/utilities/axios';
import { useBrowserStorage } from '@odh-dashboard/dashboard-shell-frontend/providers/BrowserStorageContext';
...
jest.mock('@odh-dashboard/dashboard-shell-frontend/providers/BrowserStorageContext', () => ({
