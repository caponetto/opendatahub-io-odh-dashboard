...
import HardwareProfileEnableToggle from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/HardwareProfileEnableToggle';
...
import TolerationTable from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/toleration/TolerationTable';
