...
import { formatResourceValue } from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/utils';
import { isHardwareProfileIdentifierValid } from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/pages/utils';
