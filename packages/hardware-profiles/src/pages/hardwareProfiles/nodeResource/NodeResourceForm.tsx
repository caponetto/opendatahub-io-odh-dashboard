...
import { UnitOption } from '@odh-dashboard/dashboard-foundation-frontend/utilities/valueUnits';
import SimpleSelect, {
  SimpleSelectOption,
...
} from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/nodeResource/const';
import {
