...
import { DEFAULT_PRIORITY_CLASS } from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/nodeResource/const';
import ManageResourceAllocationSection from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/manage/ManageResourceAllocationSection';

// Mock only external dependencies/hooks
jest.mock('@odh-dashboard/dashboard-foundation-frontend/concepts/areas', () => ({
  useIsAreaAvailable: jest.fn(),
  SupportedArea: jest.requireActual('@odh-dashboard/dashboard-foundation-frontend/concepts/areas')
    .SupportedArea,
  conditionalArea: jest.fn(() => (Component: React.FC) => Component),
}));
jest.mock('@odh-dashboard/dashboard-foundation-frontend/concepts/k8s/useDefaultDsc');
jest.mock('@odh-dashboard/distributed-workloads-shared/concepts/kueue/useWorkloadPriorityClasses');
