...
} from '@odh-dashboard/hardware-profiles-shared/api/k8s/hardwareProfiles';
...
import { HardwareProfileFormData } from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/manage/types';
import { humanizeHardwareProfileError } from '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/manage/utils';
