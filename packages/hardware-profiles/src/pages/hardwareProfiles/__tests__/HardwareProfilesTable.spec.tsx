...
jest.mock(
  '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/HardwareProfilesTableRow',
  () => {
...
jest.mock(
  '@odh-dashboard/hardware-profiles/pages/hardwareProfiles/DeleteHardwareProfileModal',
  () => {
...
jest.mock('@odh-dashboard/hardware-profiles/pages/hardwareProfiles/HardwareProfilesToolbar', () => {
