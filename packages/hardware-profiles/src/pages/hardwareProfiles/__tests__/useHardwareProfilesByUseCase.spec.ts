...
jest.mock('@odh-dashboard/projects-shared/concepts/projects/ProjectDetailsContext', () => ({
  ProjectDetailsContext: {
    _currentValue: null,
  },
}));

jest.mock('@odh-dashboard/hardware-profiles-shared/utilities/useWatchHardwareProfiles', () => ({
