...
import * as reduxSelectors from '@odh-dashboard/dashboard-foundation-frontend/redux/selectors';
...
import * as useHardwareProfilesModule from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/pages/useHardwareProfilesByFeatureVisibility';
...
jest.mock(
  '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/pages/useHardwareProfilesByFeatureVisibility',
);
