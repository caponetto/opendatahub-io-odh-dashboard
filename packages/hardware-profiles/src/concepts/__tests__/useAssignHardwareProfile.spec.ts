...
import * as useHardwareProfileConfigModule from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/useHardwareProfileConfig';
import { INFERENCE_SERVICE_HARDWARE_PROFILE_PATHS } from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/const';
...
jest.mock(
  '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/useHardwareProfileConfig',
  () => ({
