...
import * as areasUtils from '@odh-dashboard/dashboard-foundation-frontend/concepts/areas';
import * as appContext from '@odh-dashboard/dashboard-foundation-frontend/app/AppContext';
import { ModelServingSize } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import useServingHardwareProfileConfig from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/useServingHardwareProfileConfig';
import { useModelServingHardwareProfileState } from '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/useModelServingPodSpecOptionsState';
...
jest.mock(
  '@odh-dashboard/hardware-profiles-shared/concepts/hardwareProfiles/useServingHardwareProfileConfig',
  () => ({
    __esModule: true,
    default: jest.fn(),
  }),
