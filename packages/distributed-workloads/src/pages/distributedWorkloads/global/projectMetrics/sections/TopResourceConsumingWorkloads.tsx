...
import { truncateString } from '@odh-dashboard/dashboard-foundation-frontend/utilities/string';
import {
  bytesAsPreciseGiB,
  roundNumber,
} from '@odh-dashboard/dashboard-foundation-frontend/utilities/number';
