...
import { isEnumMember } from '@odh-dashboard/dashboard-foundation-frontend/utilities/utils';
import { WorkloadStatusType } from '@odh-dashboard/distributed-workloads-shared/concepts/distributedWorkloads/types';
import type { WorkloadWithUsage } from '../api/prometheus/distributedWorkloads';

export { WorkloadStatusType };
...
export const getStatusInfo = (wl: WorkloadKind): WorkloadStatusInfo => {
  // WorkloadKind refines the generic K8s condition shape with a stricter condition union.
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  const conditions = wl.status?.conditions as WorkloadCondition[] | undefined;
