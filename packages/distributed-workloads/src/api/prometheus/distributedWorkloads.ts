...
import { PrometheusQueryResponse } from '@odh-dashboard/dashboard-foundation-frontend/types';
import { FetchStateObject } from '@odh-dashboard/dashboard-foundation-frontend/utilities/useFetch';
import { DEFAULT_VALUE_FETCH_STATE } from '@odh-dashboard/dashboard-foundation-frontend/utilities/const';
import {
  WorkloadKind,
  WorkloadOwnerType,
} from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import usePrometheusQuery from '@odh-dashboard/dashboard-foundation-frontend/api/prometheus/usePrometheusQuery';
import {
