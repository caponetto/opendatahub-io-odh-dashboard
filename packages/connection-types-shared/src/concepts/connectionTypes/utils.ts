import { KnownLabels, SecretKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import {
...
} from '@odh-dashboard/dashboard-foundation-frontend/concepts/k8s/K8sNameDescriptionField/types';
import { enumIterator } from '@odh-dashboard/dashboard-foundation-frontend/utilities/utils';
import {
  AWSDataEntry,
  AwsKeys,
} from '@odh-dashboard/dashboard-foundation-frontend/constants/awsKeys';
import { isSecretKind } from '@odh-dashboard/dashboard-foundation-frontend/utilities/k8sTypeGuards';
import { EnvVariableDataEntry } from '#~/concepts/workbench/envVariableFormTypes';
import {
  Connection,
