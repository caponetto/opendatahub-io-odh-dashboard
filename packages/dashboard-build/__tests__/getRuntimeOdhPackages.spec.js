...
describe('getRuntimeOdhPackages', () => {
  ...
  it('should include host @odh-dashboard/* dependencies as seeds', () => {
    const packages = [
      makePackage('@odh-dashboard/dashboard-config'),
    ...
    expect(result).toEqual(
      new Set(['@odh-dashboard/dashboard-config', '@odh-dashboard/plugin-core']),
    );
  });
  ...
  it('should combine host deps and remote deps into one set', () => {
    ...
    const hostPkg = { dependencies: { '@odh-dashboard/dashboard-config': '*' } };
