...
import type { ProjectSettingsCardProps } from '@odh-dashboard/plugin-core/extension-points';
import useTrustyCRState from './useTrustyCRState';

const ModelBiasSettingsCard: React.FC<ProjectSettingsCardProps> = ({ project }) => {
