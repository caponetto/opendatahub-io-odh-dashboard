...
import { NotebookControllerContextProps } from '../../pages/notebookControllerContextTypes';
import {
...
jest.mock('@odh-dashboard/workbenches-shared/concepts/notebooks/useGetNotebookRoute', () => ({
  useGetNotebookRoute: jest.fn(),
}));

const useGetNotebookRouteMock = jest.mocked(
  require('@odh-dashboard/workbenches-shared/concepts/notebooks/useGetNotebookRoute')
    .useGetNotebookRoute,
);
