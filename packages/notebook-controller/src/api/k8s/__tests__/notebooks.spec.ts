...
import {
  ...
  ELYRA_VOLUME_NAME,
} from '@odh-dashboard/workbenches-shared/concepts/notebooks/elyraVolumeUtils';
...
jest.mock('@odh-dashboard/dashboard-foundation-frontend/api/k8sUtils', () => ({
  k8sMergePatchResource: jest.fn(),
}));

jest.mock('@odh-dashboard/workbenches-shared/concepts/notebooks/elyraVolumeUtils', () => {
  const originalModule = jest.requireActual(
    '@odh-dashboard/workbenches-shared/concepts/notebooks/elyraVolumeUtils',
  );
  return {
    ...originalModule,
  };
