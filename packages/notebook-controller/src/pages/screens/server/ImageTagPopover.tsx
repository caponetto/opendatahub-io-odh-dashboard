...
import { ImageTagInfo } from '@odh-dashboard/dashboard-foundation-frontend/types';
import { getNameVersionString } from '@odh-dashboard/dashboard-foundation-frontend/utilities/imageUtils';
