...
import type { ModelServingPlatformExtension } from '@odh-dashboard/model-serving-shared/extension-points';
    ...
    properties: {
      ...
      backport: {
        ModelsProjectDetailsTab: () =>
          import('@odh-dashboard/model-serving/pages/screens/projects/ModelServingPlatform'),
        GlobalModelsPage: () => import('@odh-dashboard/model-serving/pages/ModelServingRoutes'),
      },
    },
    flags: {
