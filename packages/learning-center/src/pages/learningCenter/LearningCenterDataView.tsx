...
import { removeQueryArgument } from '@odh-dashboard/dashboard-foundation-frontend/utilities/router';
import OdhDocCard from '@odh-dashboard/dashboard-foundation-frontend/components/OdhDocCard';
import OdhDocListItem from '@odh-dashboard/dashboard-foundation-frontend/components/OdhDocListItem';
import {
  LIST_VIEW,
  ENABLED_FILTER_KEY,
  SEARCH_FILTER_KEY,
