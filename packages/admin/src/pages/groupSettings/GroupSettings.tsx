...
import { isGroupEmpty } from '@odh-dashboard/dashboard-foundation-frontend/utilities/utils';
...
import {
  GroupsConfigField,
  GroupStatus,
} from '@odh-dashboard/dashboard-foundation-frontend/concepts/userConfigs/groupTypes';
