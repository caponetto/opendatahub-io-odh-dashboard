...
export enum StorageProvisioner {
  ...
  CEPHFS_CSI_ODF = 'openshift-storage.cephfs.csi.ceph.com',
...
export const provisionerAccessModes: Record<StorageProvisioner, AccessMode[]> = {
  ...
  [StorageProvisioner.CEPHFS_CSI_ODF]: [
    AccessMode.RWO,
    AccessMode.RWX,
    AccessMode.ROX,
    AccessMode.RWOP,
  ],
  [StorageProvisioner.RBD_CSI_ODF]: [AccessMode.RWO, AccessMode.ROX, AccessMode.RWOP],
};
