...
import { bytesAsRoundedGiB } from '@odh-dashboard/dashboard-foundation-frontend/utilities/number';
...
import ProgressBarWithLabels from '@odh-dashboard/dashboard-foundation-frontend/components/ProgressBarWithLabels';
import { usePVCFreeAmount } from '@odh-dashboard/workbenches/api/prometheus/usePVCFreeAmount';
import {
  getEffectiveCapacityGiB,
  getPvcPercentageUsed,
  getPvcRequestSize,
  getPvcTotalSize,
} from '@odh-dashboard/workbenches/pages/utils';
