...
import { MountPath } from '@odh-dashboard/workbenches/pages/types';
import BaseStorageModal from '@odh-dashboard/workbenches/pages/screens/detail/storage/BaseStorageModal';
