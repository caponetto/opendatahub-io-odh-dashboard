...
jest.mock('@odh-dashboard/storage-classes-shared/concepts/storageClasses/utils', () => ({
  getStorageClassConfig: jest.fn(),
  getPossibleStorageClassAccessModes: jest.fn(),
}));

jest.mock('@odh-dashboard/storage-classes-shared/concepts/storageClasses/AccessModeLabel', () => ({
  __esModule: true,
...
} from '@odh-dashboard/storage-classes-shared/concepts/storageClasses/utils';
