...
import { EnvVarResourceType } from '@odh-dashboard/dashboard-foundation-frontend/types';
import useFetchState, {
  NotReadyError,
} from '@odh-dashboard/dashboard-foundation-frontend/utilities/useFetchState';
import { isConnection } from '@odh-dashboard/connection-types-shared/concepts/connectionTypes/utils';
