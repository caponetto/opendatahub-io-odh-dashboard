...
import { getWorkbenchFeatureStores } from '@odh-dashboard/workbenches/api/featureStore/workbenchIntegration';
import {
  useWorkbenchFeatureStores,
  WorkbenchFeatureStoreConfig,
} from '@odh-dashboard/workbenches/pages/screens/spawner/featureStore/useWorkbenchFeatureStores';

jest.mock('@odh-dashboard/workbenches/api/featureStore/workbenchIntegration', () => ({
