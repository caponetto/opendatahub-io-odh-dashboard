...
import StorageSizeBar from '@odh-dashboard/workbenches/pages/components/StorageSizeBars';
import { getPvcAccessMode } from '@odh-dashboard/workbenches/pages/utils.ts';
import ConnectedResources from '@odh-dashboard/workbenches/pages/screens/detail/connections/ConnectedResources';
import AccessModeFullName from './AccessModeFullName';
