...
import DividedGallery from '@odh-dashboard/dashboard-foundation-frontend/concepts/design/DividedGallery';
import InfoGalleryItem from '@odh-dashboard/dashboard-foundation-frontend/concepts/design/InfoGalleryItem';
