...
import NotebookList from '@odh-dashboard/workbenches/pages/screens/detail/notebooks/NotebookList';
...
jest.mock('@odh-dashboard/workbenches/pages/notebook/useKueueNotebookAlerts', () => jest.fn());
