...
import { DATA_CONNECTION_PREFIX } from '@odh-dashboard/dashboard-foundation-frontend/api/k8s/secrets';
import {
  getNotebookPVCNames,
  getNotebookSecretNames,
} from '@odh-dashboard/workbenches/pages/pvc/utils';
