...
import { KueueWorkloadStatus } from '@odh-dashboard/distributed-workloads-shared/concepts/kueue/types';
...
import { useWatchWorkloads } from '@odh-dashboard/distributed-workloads-shared/api/k8s/workloads';
import { useKueueStatusForNotebooks } from '@odh-dashboard/workbenches/pages/notebook/useKueueStatusForNotebooks';

const notebookName = 'nb1';
const notebookName2 = 'nb2';

jest.mock('@odh-dashboard/distributed-workloads-shared/concepts/kueue/kueueUtils', () => ({
  ...jest.requireActual('@odh-dashboard/distributed-workloads-shared/concepts/kueue/kueueUtils'),
  useKueueConfiguration: jest.fn(),
}));

jest.mock('@odh-dashboard/distributed-workloads-shared/api/k8s/workloads', () => ({
  ...jest.requireActual('@odh-dashboard/distributed-workloads-shared/api/k8s/workloads'),
