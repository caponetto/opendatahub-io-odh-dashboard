import type { NotebookStatus } from '@odh-dashboard/dashboard-foundation-frontend/types';
import { EventStatus } from '@odh-dashboard/dashboard-foundation-frontend/types';
import { KueueWorkloadStatus } from '@odh-dashboard/distributed-workloads-shared/concepts/kueue/types';
import { getStatusSubtitle } from '@odh-dashboard/workbenches/pages/notebook/NotebookStateStatus';
