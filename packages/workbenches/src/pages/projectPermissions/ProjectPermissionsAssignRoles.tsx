...
} from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/PermissionsContext';
...
} from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/const';
import type { SupportedSubjectKind } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/types';
...
import NavigationBlockerModal from '@odh-dashboard/dashboard-foundation-frontend/components/NavigationBlockerModal';
