...
import { RoleAssignment } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/types';
import { ResourceRule } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import { ROLE_BINDING_DATE_CREATED_TOOLTIP } from '@odh-dashboard/workbenches/pages/projectPermissions/const';
