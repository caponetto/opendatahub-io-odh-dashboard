import { SimpleSelectOption } from '@odh-dashboard/dashboard-foundation-frontend/components/SimpleSelect';
import type { RoleRef } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/types';
import { DEFAULT_CLUSTER_ROLE_NAMES } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/const';
