...
import TypedObjectIcon from '@odh-dashboard/dashboard-foundation-frontend/concepts/design/TypedObjectIcon';
import SubjectNameTypeaheadSelect from '@odh-dashboard/workbenches/pages/projectPermissions/components/SubjectNameTypeaheadSelect';
