...
import { useCheckboxTableBase } from '@odh-dashboard/dashboard-foundation-frontend/components/table';
import { usePermissionsContext } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/PermissionsContext';
import {
  buildGroupRoleMap,
  buildUserRoleMap,
  getRoleByRef,
...
import {
  ...
  getSubjectRef,
} from '@odh-dashboard/workbenches/pages/projectPermissions/utils';
import type { SubjectKindSelection } from '@odh-dashboard/workbenches/pages/projectPermissions/types';
