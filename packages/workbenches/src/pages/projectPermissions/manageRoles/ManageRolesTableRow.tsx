...
import { ODH_PRODUCT_NAME } from '@odh-dashboard/dashboard-foundation-frontend/utilities/const.ts';
...
import RoleDetailsLink from '@odh-dashboard/workbenches/pages/projectPermissions/components/RoleDetailsLink';
