...
import useManageRolesData from '@odh-dashboard/workbenches/pages/projectPermissions/manageRoles/useManageRolesData';

const mockUsePermissionsContext = jest.fn();

jest.mock(
  '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/PermissionsContext',
  () => ({
