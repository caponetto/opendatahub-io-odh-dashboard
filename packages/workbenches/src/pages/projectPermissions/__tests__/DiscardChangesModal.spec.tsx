...
import DiscardChangesModal from '@odh-dashboard/workbenches/pages/projectPermissions/manageRoles/confirmModal/DiscardChangesModal';
import { PendingChangeType } from '@odh-dashboard/workbenches/pages/projectPermissions/types';
