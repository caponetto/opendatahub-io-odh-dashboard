...
import { OPENSHIFT_BOOTSTRAPPING_DEFAULT_VALUE } from '@odh-dashboard/dashboard-foundation-frontend/concepts/permissions/const';
import { KnownLabels, type RoleKind } from '@odh-dashboard/dashboard-foundation-frontend/k8sTypes';
import { mockClusterRoleK8sResource } from '@odh-dashboard/test-mocks/mockClusterRoleK8sResource';
import { mockRoleBindingK8sResource } from '@odh-dashboard/test-mocks/mockRoleBindingK8sResource';
import { mockRoleK8sResource } from '@odh-dashboard/test-mocks/mockRoleK8sResource';
import {
  mockGroupRoleBindingSubject,
  mockUserRoleBindingSubject,
} from '@odh-dashboard/test-mocks/mockRoleBindingSubject';
import SubjectRolesTableRow from '@odh-dashboard/workbenches/pages/projectPermissions/SubjectRolesTableRow';
import {
  buildSubjectRoleRows,
  SubjectRolesTableBase,
} from '@odh-dashboard/workbenches/pages/projectPermissions/SubjectRolesTable';
import type { SubjectRoleRow } from '@odh-dashboard/workbenches/pages/projectPermissions/types';
...
describe('SubjectRolesTable', () => {
  ...
  it('should render role links and rowSpan grouping, and split rowSpan blocks after sorting', () => {
    ...
    const withDisplayName = <
      T extends { metadata: { annotations?: Record<string, string | undefined> } },
    >(
      resource: T,
      displayName: string,
    ): T => ({
    ...
    const roles: RoleKind[] = [
      ...
      dashboardRole,
      openshiftCustomRole1,
      openshiftCustomRole2,
    ];
