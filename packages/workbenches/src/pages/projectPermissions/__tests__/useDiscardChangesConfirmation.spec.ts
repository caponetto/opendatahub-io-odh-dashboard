...
import useDiscardChangesConfirmation from '@odh-dashboard/workbenches/pages/projectPermissions/manageRoles/useDiscardChangesConfirmation';
import {
  PendingChangeType,
  type SubjectKindSelection,
} from '@odh-dashboard/workbenches/pages/projectPermissions/types';
